...
-- ON DELETE SET NULL put for foreign keys
...
-- SELECT type, sql FROM sqlite_master WHERE tbl_name='employee';
...
-- due to circular relationship of the tables
-- since branch table is empty, so leave the two foreign key null and change them later
